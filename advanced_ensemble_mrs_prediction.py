#!/usr/bin/env python3
"""
Advanced Ensemble mRS Prediction Model
Includes CatBoost, XGBoost, and multiple advanced algorithms for comprehensive comparison
"""
import pandas as pd
import numpy as np
...
def advanced_ensemble_mrs_prediction():
    print("=== ADVANCED ENSEMBLE MRS PREDICTION MODEL ===\n")
    ...
    print(f"\n🤖 Training and evaluating {len(models)} advanced models...")
    results = {}
    ...
    print(f"\n📊 ADVANCED ENSEMBLE MODEL PERFORMANCE SUMMARY")
    ...
    predictions_df.to_csv('advanced_ensemble_predictions.csv', index=False)
    print(f"   Saved predictions to: advanced_ensemble_predictions.csv")
    ...
    comparison_df.to_csv('advanced_ensemble_comparison.csv', index=False)
    print(f"   Saved model comparison to: advanced_ensemble_comparison.csv")
    
    # Save feature importance if available
    if hasattr(best_result['model'], 'feature_importances_'):
        feature_importance.to_csv('advanced_ensemble_feature_importance.csv', index=False)
        print(f"   Saved feature importance to: advanced_ensemble_feature_importance.csv")
    
    print(f"\n✅ ADVANCED ENSEMBLE MRS PREDICTION COMPLETE!")
...
if __name__ == "__main__":
    advanced_ensemble_mrs_prediction() 