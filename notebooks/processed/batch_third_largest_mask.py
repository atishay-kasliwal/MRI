...
parser = argparse.ArgumentParser(description='Batch generate third largest masks.')
...
for patient_dir in DATA_ROOT.iterdir():
    ...
    for percentile in PERCENTILES:
        output_path = mask_dir / f"third_largest_p{percentile}_mask_{patient_dir.name}.nii.gz"
        generate_mask(nii_path, output_path=output_path, component=3, threshold_percentile=percentile) 