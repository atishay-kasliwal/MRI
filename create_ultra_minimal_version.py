#!/usr/bin/env python3
"""
Create Ultra Minimal Version - Remove All Branding
Remove golden footer line and Wake Forest University School of Medicine text
"""
...
def add_ultra_minimal_footer(fig, page_num):
    ...
    # NO golden line
    # NO Wake Forest University School of Medicine text
...
def create_ultra_minimal_gillies_analysis(our_data):
    """Create ultra minimal Gillies analysis with no branding"""
    print("📊 Creating ultra minimal Gillies analysis...")
    
    with PdfPages('gillies_2016_ultra_minimal.pdf') as pdf:
        ...
        # Ultra minimal footer - just page number
    ...
    print("✅ Ultra minimal Gillies analysis saved to: gillies_2016_ultra_minimal.pdf")

def main():
    """Create ultra minimal analysis with no branding"""
    print("📄 Creating ultra minimal analysis...")
    
    # Load our actual data
    our_data = load_our_data()
    
    # Create ultra minimal analysis
    create_ultra_minimal_gillies_analysis(our_data)
    
    print("\n✅ Ultra minimal analysis created successfully!")
    print("📁 Generated Files:")
    print("   • gillies_2016_ultra_minimal.pdf (3 pages)")
    print("\n🎨 Ultra minimal design - no golden line, no branding text!")
