#!/usr/bin/env python3
"""
Create Enhanced Wake Forest Theme Analysis for All Papers
...
def create_enhanced_gillies_analysis(our_data):
    """Create enhanced Gillies analysis"""
    print("📊 Creating enhanced Gillies analysis...")
    
    with PdfPages('gillies_2016_enhanced_all_papers.pdf') as pdf:
    ...
    print("✅ Enhanced Gillies analysis saved to: gillies_2016_enhanced_all_papers.pdf")

def create_enhanced_aerts_analysis(our_data):
    """Create enhanced Aerts analysis"""
    print("🎯 Creating enhanced Aerts analysis...")
    
    with PdfPages('aerts_2014_enhanced_all_papers.pdf') as pdf:
        ...
        fig.suptitle('OUR RADIOMICS SIGNATURE ANALYSIS', fontsize=22, fontweight='bold', 
                     color=WAKE_FOREST_COLORS['primary_gold'], fontfamily='Arial', y=0.95)
        
        # Enhanced Signature components
        if our_data['feature_importances'] is not None:
            feature_df = our_data['feature_importances']
            if len(feature_df) > 0:
                ...
                wedges, texts, autotexts = ax1.pie(importance_scores, labels=feature_names, autopct='%1.1f%%', 
                                                  startangle=90, colors=colors, 
                                                  textprops={'fontsize': 11, 'fontfamily': 'Arial'},
                                                  explode=(0.05, 0.05, 0.05, 0.05))
                ...
                style_enhanced_subplot(ax1, 'Our 4-Feature Signature')
            else:
                ax1.text(0.5, 0.5, 'Feature Data\nNot Available', ha='center', va='center', 
                        fontsize=14, color=WAKE_FOREST_COLORS['dark_grey'], fontfamily='Arial',
                        bbox=dict(boxstyle="round,pad=0.5", facecolor=WAKE_FOREST_COLORS['very_light_grey'],
        ...
        style_enhanced_subplot(ax2, 'Risk Stratification')
        ax2.set_ylabel('Patient Distribution (%)', fontfamily='Arial', fontweight='bold')
        ...
        style_enhanced_subplot(ax3, 'Validation Performance')
        ax3.set_ylabel('AUC Score', fontfamily='Arial', fontweight='bold')
        ax3.set_ylim(0, 1)
        ...
        style_enhanced_subplot(ax4, 'Clinical Integration')
        ax4.set_ylabel('AUC Score', fontfamily='Arial', fontweight='bold')
        ax4.set_ylim(0, 1)
    ...
    print("✅ Enhanced Aerts analysis saved to: aerts_2014_enhanced_all_papers.pdf")

def main():
    """Create enhanced Wake Forest theme analysis for all papers"""
    print("📄 Creating enhanced Wake Forest theme analysis for all papers...")
    
    # Load our actual data
    our_data = load_our_data()
    
    # Create enhanced analysis for each paper
    create_enhanced_gillies_analysis(our_data)
    create_enhanced_aerts_analysis(our_data)
    
    print("\n✅ Enhanced Wake Forest University School of Medicine theme analysis created successfully!")
    print("📁 Generated Files:")
    print("   • gillies_2016_enhanced_all_papers.pdf (3 pages)")
    print("   • aerts_2014_enhanced_all_papers.pdf (2 pages)")
