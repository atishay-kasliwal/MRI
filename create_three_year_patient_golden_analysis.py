...
class ThreeYearPatientGoldenAnalyzer:
    """
    Three-Year Patient-Level Analysis with Golden Theme
    Includes 2020, 2021, and 2022 data
    ...
    def _load_all_data(self):
        ...
        try:
            ...
            print(f"Combined dataset: {len(self.data_combined)} total scans")
    ...
    def create_analysis(self, target_col='Last mRS', output_path='three_year_patient_golden_analysis.pdf'):
        """Create three-year patient-level analysis with golden theme"""
        ...
        print(f"✅ Three-year patient-level golden analysis saved to {output_path}")
    ...
    def _create_three_year_overview(self, pdf, target_col):
        ...
        fig.suptitle('Three-Year Patient-Level Data Overview', fontsize=16, fontweight='bold', color=GOLDEN_COLORS['dark_gold'])
        ...
        axes[0, 1].set_title('Patient Distribution by Year', fontweight='bold', color=GOLDEN_COLORS['dark_gold'])
        ...
        table.scale(1, 2)
        axes[1, 1].set_title('Three-Year Dataset Summary', fontweight='bold', color=GOLDEN_COLORS['dark_gold'])
        axes[1, 1].axis('off')
    ...
    def _create_model_comparison(self, pdf, target_col):
        ...
        fig, axes = plt.subplots(2, 2, figsize=(16, 12))
        fig.suptitle('Three-Year Patient-Level Model Performance: Train vs Test', fontsize=16, fontweight='bold', color=GOLDEN_COLORS['dark_gold'])
    ...
    def _create_feature_importance(self, pdf, target_col):
        ...
        fig, axes = plt.subplots(2, 2, figsize=(16, 12))
        fig.suptitle('Three-Year Patient-Level Feature Importance Analysis', fontsize=16, fontweight='bold', color=GOLDEN_COLORS['dark_gold'])
    ...
    def _create_feature_set_analysis(self, pdf, target_col):
        ...
        fig.suptitle('Three-Year Patient-Level Prediction Accuracy by Feature Set', fontsize=16, fontweight='bold', color=GOLDEN_COLORS['dark_gold'])
    ...
    def _create_cv_analysis(self, pdf, target_col):
        ...
        # Create visualization with golden theme
        fig, axes = plt.subplots(1, 2, figsize=(16, 6))
        fig.suptitle('Three-Year Patient-Level Cross-Validation Analysis', fontsize=16, fontweight='bold', color=GOLDEN_COLORS['dark_gold'])
...
def main():
    """Main function to run three-year patient-level golden analysis"""
    print("=== THREE-YEAR PATIENT-LEVEL GOLDEN RADIOMICS ANALYSIS ===")
    print("Analyzing patient-level predictions across 2020, 2021, and 2022...\n")
    
    # Initialize analyzer with all three years of data
    analyzer = ThreeYearPatientGoldenAnalyzer()
    
    # Create analysis
    analyzer.create_analysis('Last mRS', 'three_year_patient_golden_analysis.pdf')
    
    print("\n=== ANALYSIS COMPLETED ===")
    print("Generated analyses include:")
    print("1. Three-Year Data Overview")
    ...
    print("- Three-year comprehensive dataset")
