#!/usr/bin/env python3
"""
Remove Branding Border to Fix White Space Issues
Remove the rounded rectangular border around Wake Forest branding
"""
...
def add_wake_forest_footer_clean(fig, page_num):
    """Add clean Wake Forest University School of Medicine footer without borders"""
...
def create_enhanced_title_page_clean(title, subtitle, description):
    """Create enhanced title page with clean styling - no borders"""
    ...
    # Main title with clean styling - NO BORDER
    ...
    # Subtitle with clean styling - NO BORDER
    plt.text(0.5, 0.85, subtitle, 
            fontsize=18, ha='center', va='center', 
            color=WAKE_FOREST_COLORS['black'], fontfamily='Arial')
    
    # Description with elegant styling - NO BORDER
    ...
    # Add footer
    add_wake_forest_footer_clean(fig, 1)
...
def create_clean_gillies_analysis(our_data):
    """Create clean Gillies analysis without branding borders"""
    print("📊 Creating clean Gillies analysis...")
    
    with PdfPages('gillies_2016_clean_branding.pdf') as pdf:
        
        # Page 1: Enhanced Title Page
        fig = create_enhanced_title_page_clean(
            'GILLIES ET AL. (2016)',
        ...
        add_wake_forest_footer_clean(fig, 2)
        pdf.savefig(fig, bbox_inches='tight', facecolor=WAKE_FOREST_COLORS['off_white'])
        plt.close()
        ...
        # Better spacing
        plt.tight_layout(pad=2.0)
        add_wake_forest_footer_clean(fig, 3)
        pdf.savefig(fig, bbox_inches='tight', facecolor=WAKE_FOREST_COLORS['off_white'])
        plt.close()
    
    print("✅ Clean Gillies analysis saved to: gillies_2016_clean_branding.pdf")

def main():
    """Create clean Wake Forest theme analysis without branding borders"""
    print("📄 Creating clean Wake Forest theme analysis without branding borders...")
    
    # Load our actual data
    our_data = load_our_data()
    
    # Create clean analysis
    create_clean_gillies_analysis(our_data)
    
    print("\n✅ Clean Wake Forest University School of Medicine theme analysis created successfully!")
    print("📁 Generated Files:")
    print("   • gillies_2016_clean_branding.pdf (3 pages)")
    print("\n🎨 Removed branding borders to eliminate white space issues!")
