...
class SimpleCompleteAnalyzer:
    """
    Simple Complete Three-Year Analysis with Golden Theme
    Uses 2021 data (which already has mRS) and shows data availability
    ...
    def _load_all_data(self):
        """Load radiomics data from all three years"""
        try:
            # Load radiomics data
            ...
            # For analysis, we'll use 2021 data since it has the target variable
    ...
    def create_analysis(self, target_col='Last mRS', output_path='simple_complete_analysis.pdf'):
        """Create simple complete three-year analysis with golden theme"""
        ...
        print(f"✅ Simple complete three-year analysis saved to {output_path}")
    ...
    def _create_complete_overview(self, pdf, target_col):
        ...
        axes[0, 1].set_title('Available Patients by Year\n(All years have radiomics, 2021 has mRS)', fontweight='bold', color=GOLDEN_COLORS['dark_gold'])
...
def main():
    """Main function to run simple complete three-year analysis"""
    print("=== SIMPLE COMPLETE THREE-YEAR PATIENT-LEVEL GOLDEN RADIOMICS ANALYSIS ===")
    print("Analyzing patient-level predictions with complete three-year dataset...\n")
    
    # Initialize analyzer with all three years of data
    analyzer = SimpleCompleteAnalyzer()
    
    # Create analysis
    analyzer.create_analysis('Last mRS', 'simple_complete_analysis.pdf')
    ...
    print("- Complete three-year dataset overview")
